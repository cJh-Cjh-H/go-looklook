...
func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	lookLookUserIdKey := fmt.Sprintf("%s%v", cacheLookLookUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, lookLookUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	...
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, lookLookUserMobileKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
